...
class BasePolicy:
    @property
    def read_mode_ap(self) -> ReadModeAP: ...
    @read_mode_ap.setter
    def read_mode_ap(self, value: ReadModeAP) -> None: ...
    @property
    def read_mode_sc(self) -> ReadModeSC: ...
    @read_mode_sc.setter
    def read_mode_sc(self, value: ReadModeSC) -> None: ...
    @property
...
class BatchDeleteOp:
    ...
    """
    def __new__(cls, key:Key, policy:typing.Optional[BatchDeletePolicy]=None) -> BatchDeleteOp: ...
...
class BatchReadOp:
    ...
    """
    def __new__(cls, key:Key, bins:typing.Optional[typing.Sequence[builtins.str]]=None, operations:typing.Optional[typing.Sequence[typing.Any]]=None, policy:typing.Optional[BatchReadPolicy]=None) -> BatchReadOp: ...
...
class BatchWriteOp:
    ...
    """
    def __new__(cls, key:Key, operations:typing.Sequence[typing.Any], policy:typing.Optional[BatchWritePolicy]=None) -> BatchWriteOp: ...
...
class CTX:
    ...
    def all_children() -> CTX:
        ...
        """
    @staticmethod
    def all_children_with_filter(exp:FilterExpression) -> CTX:
        r"""
...
class Filter:
    ...
    @staticmethod
    def equal_by_index(index_name:builtins.str, value:typing.Any) -> Filter: ...
    @staticmethod
    def range(bin_name:builtins.str, begin:typing.Any, end:typing.Any) -> Filter: ...
    @staticmethod
    def range_by_index(index_name:builtins.str, begin:typing.Any, end:typing.Any) -> Filter: ...
    @staticmethod
    def contains(bin_name:builtins.str, value:typing.Any, cit:typing.Optional[CollectionIndexType]) -> Filter: ...
    @staticmethod
    def contains_by_index(index_name:builtins.str, value:typing.Any, cit:typing.Optional[CollectionIndexType]) -> Filter: ...
    @staticmethod
    def contains_range(bin_name:builtins.str, begin:typing.Any, end:typing.Any, cit:typing.Optional[CollectionIndexType]) -> Filter: ...
    @staticmethod
    def contains_range_by_index(index_name:builtins.str, begin:typing.Any, end:typing.Any, cit:typing.Optional[CollectionIndexType]) -> Filter: ...
    @staticmethod
    def within_region(bin_name:builtins.str, region:builtins.str, cit:typing.Optional[CollectionIndexType]) -> Filter: ...
    @staticmethod
    def within_region_by_index(index_name:builtins.str, region:builtins.str, cit:typing.Optional[CollectionIndexType]) -> Filter: ...
    @staticmethod
    def within_radius(bin_name:builtins.str, lng:builtins.float, lat:builtins.float, radius:builtins.float, cit:typing.Optional[CollectionIndexType]) -> Filter:
        ...
        """
    @staticmethod
    def within_radius_by_index(index_name:builtins.str, lng:builtins.float, lat:builtins.float, radius:builtins.float, cit:typing.Optional[CollectionIndexType]) -> Filter: ...
    @staticmethod
    def regions_containing_point(bin_name:builtins.str, point:builtins.str, cit:typing.Optional[CollectionIndexType]) -> Filter: ...
    @staticmethod
    def regions_containing_point_by_index(index_name:builtins.str, point:builtins.str, cit:typing.Optional[CollectionIndexType]) -> Filter: ...
...
class FilterExpression:
    ...
    def hll_may_contain(list:FilterExpression, bin:FilterExpression) -> FilterExpression:
        ...
        """
    @staticmethod
    def bool_loop_var(part:LoopVarPart) -> FilterExpression:
        r"""
        ...
        """
    @staticmethod
    def int_loop_var(part:LoopVarPart) -> FilterExpression:
        r"""
        ...
        """
    @staticmethod
    def float_loop_var(part:LoopVarPart) -> FilterExpression:
        r"""
        ...
        """
    @staticmethod
    def string_loop_var(part:LoopVarPart) -> FilterExpression:
        r"""
        ...
        """
    @staticmethod
    def list_loop_var(part:LoopVarPart) -> FilterExpression:
        r"""
        ...
        """
    @staticmethod
    def map_loop_var(part:LoopVarPart) -> FilterExpression:
        r"""
        ...
        """
    @staticmethod
    def blob_loop_var(part:LoopVarPart) -> FilterExpression:
        r"""
        ...
        """
    @staticmethod
    def hll_loop_var(part:LoopVarPart) -> FilterExpression:
        r"""
        ...
        """
    @staticmethod
    def nil_loop_var(part:LoopVarPart) -> FilterExpression:
        r"""
        ...
        """
    @staticmethod
    def geo_json_loop_var(part:LoopVarPart) -> FilterExpression:
        r"""
        ...
        """
    @staticmethod
    def remove_result() -> FilterExpression:
        r"""
...
class GeoJSON:
    ...
    def __new__(cls, v:typing.Any) -> GeoJSON: ...
    def as_string(self) -> builtins.str:
        r"""
        Returns a string representation of the value.
        """
...
class ResultCode:
    ...
    MRT_BLOCKED: ResultCode
    MRT_VERSION_MISMATCH: ResultCode
    MRT_EXPIRED: ResultCode
    MRT_TOO_MANY_WRITES: ResultCode
    MRT_COMMITTED: ResultCode
    MRT_ABORTED: ResultCode
    MRT_ALREADY_LOCKED: ResultCode
    MRT_MONITOR_EXISTS: ResultCode
...
class Role:
    ...
    def name(self) -> builtins.str:
        ...
        """
    @property
    def privileges(self) -> builtins.list[Privilege]:
        r"""
...
class Statement:
    ...
    def __new__(cls, namespace:builtins.str, set_name:typing.Optional[str] = None, bins:typing.Optional[typing.Sequence[builtins.str]]=None) -> Statement: ...
...
class Txn:
    ...
    def state(self) -> TxnState:
        ...
        """
    @state.setter
    def state(self, value: TxnState) -> None:
        r"""
