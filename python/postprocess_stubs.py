...
def add_client_stubs(content: str) -> str:
    ...
    def batch(self, batch_policy: typing.Optional[BatchPolicy], ops: typing.Sequence[typing.Union[BatchReadOp, BatchWriteOp, BatchDeleteOp]]) -> typing.Awaitable[typing.Sequence[BatchRecord]]: ...
